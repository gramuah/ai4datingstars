...
plt.savefig('../../results/testing/Benchmark_B1_MAE_hist.pdf')
...
for name, model in models.items():
	...
	plt.savefig('../../results/testing/Benchmark_B1_'+name+'_fig1.pdf')
	...
	plt.legend()
	plt.grid(True)
	plt.savefig('../../results/testing/Benchmark_B1_'+name+'_fig2.pdf')
