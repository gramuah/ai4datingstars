...
plt.savefig('../../results/training_testing/Benchmark_B2_MAE_hist.pdf')
...
for name, model in models.items():
	...
	plt.savefig('../../results/training_testing/Benchmark_B2_'+name+'_fig1.pdf')
	...
	plt.legend()
	plt.grid(True)
	plt.savefig('../../results/training_testing/Benchmark_B2_'+name+'_fig2.pdf')
